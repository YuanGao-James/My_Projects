...
epochs = 100
input_size = (256, 256)
# 图片总数 Abnormal + Background + Normal
num_pic = 843 + 2958 + 23475
# 图片类型
num_classes = 3
...
def read_directory(directory_name,num_folder):
    i = 0
    for filename in os.listdir(directory_name):
        if filename == 'desktop.ini': continue
        if num_folder == 2:
...
# j = 0
# for directory in os.listdir(r'C:/Pycharm Project/Using_AI/data_256'):
#     read_directory_for_train(r'C:/Pycharm Project/Using_AI/data_256' + '/' + directory, j)
#     # class_name.append(directory)
#     j = j + 1
# j = 0
# for directory in os.listdir(r'C:/Pycharm Project/Using_AI/data_512'):
#     read_directory(r'C:/Pycharm Project/Using_AI/data_512' + '/' + directory, j)
#     # class_name.append(directory)
#     j = j + 1
# # read_directory(r'C:/Pycharm Project/Using_AI/data_256/Normal', 2)
...
# 建立网络
model = ResNet50(input_shape=(256, 256, 1), classes=num_classes)
...
model.load_weights(r'ResNet_5.4.h5', by_name='True')
...
# 保存模型
model.save('ResNet_5.4.h5')

# 输出标签
for filename in os.listdir(r'C:/Pycharm Project/Using_AI/Raw_data_512'):
    img1 = cv2.imdecode(np.fromfile(r'C:/Pycharm Project/Using_AI/Raw_data_512/' + filename, dtype=np.uint8), -1)
    img2 = cv2.resize(img1, (256, 256))
    x_pre = img2.reshape((1,256,256,1))
    y_pre = model.predict(x_pre)
    cv2.imwrite('C:/Pycharm Project/Using_AI/Raw_data_512_result/' + str(class_name[np.argmax(y_pre)]) + '/' +
                filename, img1)
    print(filename)
# for i in range(len(y_train)):
#     cv2.imwrite('C:/Pycharm Project/Using_AI/Train_data/' + str(class_name[np.argmax(y_train[i])]) + '_' + str(i) +
#                 '.jpg', x_train[i])
...
#     x_pre = x_test[i].reshape((1,256,256,1))
#     # time_start = time.time()  # 开始计时
#     y_pre = model.predict(x_pre)
#     # time_end = time.time()  # 结束计时
#     # time_c = time_end - time_start  # 运行所花时间
#     # print('time cost', time_c, 's')
#     classes = np.argmax(y_pre)
#     # print(i)
#     # print(y_pre)

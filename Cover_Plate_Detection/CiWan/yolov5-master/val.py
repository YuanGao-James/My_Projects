...
def parse_opt():
    ...
    parser.add_argument('--data', type=str, default=ROOT / 'data/CW.yaml', help='dataset.yaml path')
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / 'weights/CW_best2.pt', help='model.pt path(s)')
